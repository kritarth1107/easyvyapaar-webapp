  ...
  dashboard: {
    ...
    staff: {
      ...
      payroll: {
        ...
        adjustments: string;
        lockedPaid: string;
        lockedGenerated: string;
        generateFor: string;
        monthsGenerated: string;
        totalDisbursed: string;
        colMonth: string;
        colPayThrough: string;
        colAction: string;
        viewDetail: string;
        detailTitle: string;
        detailPageHint: string;
        detailError: string;
        totalBasic: string;
        paidCount: string;
        fullSalary: string;
        ...
        paymentRemarkPlaceholder: string;
        paidOn: string;
        alreadyPaid: string;
        empty: string;
        ...
        alreadyGeneratedThrough: string;
        ...
        applyFromDatePending: string;
        attendanceMismatchBlocked: string;
        noEditableStaff: string;
        generateNoRecords: string;
      ...
      attendance: {
        ...
        leave: string;
        mark: string;
        markModalTitle: string;
        markModalHint: string;
        noStaff: string;
        saving: string;
        saveError: string;
        colDate: string;
        ...
        leaveRequestsHint: string;
        leaveRequestsEmpty: string;
        leaveRequestsPending: string;
        leaveRequestsApproved: string;
        leaveRequestsRejected: string;
        leaveRequestsAll: string;
        leaveFrom: string;
        leaveTo: string;
        leaveReason: string;
        leaveStatus: string;
        ...
        leaveActions: string;
        staffCount: string;
        totalMarkedDays: string;
        leavePageSubtitle: string;
        createLeaveRequest: string;
        createLeaveHint: string;
        cancelLeave: string;
        leaveReasonPlaceholder: string;
        leaveActionError: string;
        viewLeaveRequests: string;
      };
    };
    reports: {
      subtitle: string;
