...
export function InvoicePreviewGstAdvanceA5(props: InvoicePreviewProps) {
  const {
    businessName,
    accentHex,
    showPartyBalance,
  ...
  const documentNode = (
      ...
      >
        <div className="invoice-doc-border box-border flex h-full min-h-full flex-1 flex-col border border-black">
          {/* Title */}
          <div
            className="flex shrink-0 items-center gap-2 border-b border-black px-[8px]"
            style={{ height: 26 }}
          >
            <span style={{ fontSize: "14px", fontWeight: 700 }}>{content.documentTitle}</span>
            <span
          ...
          {/* Bill To */}
          <div className="flex shrink-0 border-b border-black" style={{ minHeight: 64 }}>
            ...
            <div className="p-[6px]" style={{ width: 168 }}>
              <InvoicePreviewShippingAddress content={content} fontSize={10} />
            </div>
          </div>
